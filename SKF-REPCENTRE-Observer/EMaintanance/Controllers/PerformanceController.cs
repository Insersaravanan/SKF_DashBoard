...
namespace EMaintanance.Controllers
{
    ...
    public class PerformanceController : Controller
    {
        ...
        public PerformanceController(IConfiguration configuration, IHostingEnvironment environment)
        {
        ...
        public IActionResult GetReport()
        {
            ...
            var path = Path.Combine(_hostingEnvironment.WebRootPath, "reports/PerformanceDashboard.mrt");
            report.Load(path);
