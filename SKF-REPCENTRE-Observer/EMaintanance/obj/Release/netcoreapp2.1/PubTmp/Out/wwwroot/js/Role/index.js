...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'RoleName', displayName: 'Role Name', cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'Descriptions', displayName: 'Descriptions', cellClass: getCellClass, enableColumnResizing: true, width: "35%", minWidth: 300 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip="Edit Role" tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.roleProgramPrivilage(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip="Role Program Privilege Relation" tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "16%",
            minWidth: 100
        }
