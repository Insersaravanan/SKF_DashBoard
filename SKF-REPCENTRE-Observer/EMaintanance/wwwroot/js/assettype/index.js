...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'AssetTypeCode', displayName: 'Asset Type Code', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'AssetTypeName', displayName: 'Asset Type Name', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 150 },
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip="Edit Asset Type" tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.IndustryRel(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip="Asset Type - Asset Class Relation" tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "9%",
            minWidth: 100
        }
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        { name: 'AssetTypeName', displayName: 'Asset Type Name', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
