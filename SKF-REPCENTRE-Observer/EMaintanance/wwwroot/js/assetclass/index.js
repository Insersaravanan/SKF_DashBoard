...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'AssetClassCode', displayName: 'Asset Class Code', cellClass: getCellClass,enableColumnResizing: true, width: "15%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'AssetClassName', displayName: 'Asset Class Name', cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 150 },
        { name: 'Descriptions', displayName: 'Descriptions', cellClass: getCellClass, enableColumnResizing: true, width: "33%", minWidth: 300 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip="Edit Asset Class" tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.IndustryRel(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip="Asset Class - Industry Relation" tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "11%",
            minWidth: 100
        }
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'AssetClassName', displayName: 'Asset Class Name', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
...
app.controller('skfAssetTypeClassRelModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'SegmentName', displayName: 'Segment', enableCellEdit: false, enableFiltering: true, minWidth: 150
        },
        {
            name: 'IndustryName', displayName: 'Industry', enableCellEdit: false, enableFiltering: true, minWidth: 150
        },
        {
