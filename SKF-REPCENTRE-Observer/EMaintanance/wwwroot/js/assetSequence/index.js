...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'AssetTypeCode', displayName: 'Asset Type Code', cellClass: getCellClass, enableColumnResizing: true, width: "8%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'AssetTypeName', displayName: 'Asset Type Name', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 150, aggregationHideLabel: false
        },
        {
            name: 'AssetSequenceCode', displayName: 'Asset Sequence Code', cellClass: getCellClass, enableColumnResizing: true, width: "8%", minWidth: 100, aggregationHideLabel: false
           
        },
        { name: 'AssetSequenceName', displayName: 'Asset Sequence Name', cellClass: getCellClass, enableColumnResizing: true, width: "18%", minWidth: 150 },
        { name: 'Descriptions', displayName: 'Descriptions', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 300 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip="Edit Asset Sequence" tooltip-class="customClass"></i></a>' +
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns= [
        ...
        { name: 'AssetSequenceName', displayName: 'Asset Sequence Name', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
